...
export default function Contact() {
  return (
    <div
      id="contact"
      className="relative -mx-6 -mb-6 flex h-[calc(100vh-(1.5rem*2))] flex-col justify-between gap-10 rounded-t-[20px] bg-[linear-gradient(0deg,rgba(0,0,0,1)0%,rgba(0,0,0,0)50%),url('/nahida-cafe-day.gif')] bg-cover bg-[-58%_center] p-6 text-white
      dark:bg-[linear-gradient(0deg,rgba(0,0,0,1)0%,rgba(0,0,0,0)50%),url('/nahida-cafe-night.gif')] 540px:bg-[-103%_center] md:mx-0 md:mb-0 md:h-[calc(100vh-3rem-1px)] md:bg-[-80%_center] md:pb-12 lg:bg-right"
    >
